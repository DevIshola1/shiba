(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2077], {
        92077: function(e, r, t) {
            ...
            n = function() {
                ...
                return (e = function(t) {
                        ...
                        if (e.isNumeral(t)) i = t.value();
                            ...
                            else if (a.nullFormat && t === a.nullFormat || !t.replace(/[^0-9]+/g, "").length) i = null;
                        else {
                            for (o in n)
                                if ((s = "function" === typeof n[o].regexps.unformat ? n[o].regexps.unformat() : n[o].regexps.unformat) && t.match(s)) {
                                    u = n[o].unformat;
                                    break
                                }
                        ...
                        return new l(t, i)
                    }).version = t, e.isNumeral = function(e) {
                        return e instanceof l
                    }, e._ = r = {
                        numberToFormat: function(r, t, n) {
                            var o, a, l, u, s, c, f, m = i[e.options.currentLocale],
                                h = !1,
                                d = !1,
                                b = 0,
                                p = "",
                                ...
                                F = "",
                                x = !1;
                            if (r = r || 0, a = Math.abs(r), e._.includes(t, "(") ? (h = !0, t = t.replace(/[\(|\)]/g, "")) : (e._.includes(t, "+") || e._.includes(t, "-")) && (s = e._.includes(t, "+") ? t.indexOf("+") : r < 0 ? t.indexOf("-") : -1, t = t.replace(/[\+|\-]/g, "")), e._.includes(t, "a") && (o = !!(o = t.match(/a(k|m|b|t)?/)) && o[1], e._.includes(t, " a") && (p = " "), t = t.replace(new RegExp(p + "a[kmbt]?"), ""), a >= g && !o || "t" === o ? (p += m.abbreviations.trillion, r /= g) : a < g && a >= v && !o || "b" === o ? (p += m.abbreviations.billion, r /= v) : a < v && a >= _ && !o || "m" === o ? (p += m.abbreviations.million, r /= _) : (a < _ && a >= y && !o || "k" === o) && (p += m.abbreviations.thousand, r /= y)), e._.includes(t, "[.]") && (d = !0, t = t.replace("[.]", ".")), l = r.toString().split(".")[0], u = t.split(".")[1], c = t.indexOf(","), b = (t.split(".")[0].split(",")[0].match(/0/g) || []).length, u ? (e._.includes(u, "[") ? (u = (u = u.replace("]", "")).split("["), F = e._.toFixed(r, u[0].length + u[1].length, n, u[1].length)) : F = e._.toFixed(r, u.length, n), l = F.split(".")[0], F = e._.includes(F, ".") ? m.delimiters.decimal + F.split(".")[1] : "", d && 0 === Number(F.slice(1)) && (F = "")) : l = e._.toFixed(r, 0, n), p && !o && Number(l) >= 1e3 && p !== m.abbreviations.trillion) switch (l = String(Number(l) / 1e3), p) {
                            ...
                            if (e._.includes(l, "-") && (l = l.slice(1), x = !0), l.length < b)
                                for (var w = b - l.length; w > 0; w--) l = "0" + l;
                            return c > -1 && (l = l.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + m.delimiters.thousands)), 0 === t.indexOf(".") && (l = ""), f = l + F + (p || ""), h ? f = (h && x ? "(" : "") + f + (h && x ? ")" : "") : s >= 0 ? f = 0 === s ? (x ? "-" : "+") + f : f + (x ? "-" : "+") : x && (f = "-" + f), f
                        },
                        stringToNumber: function(e) {
                            var r, t, n, o = i[a.currentLocale],
                                l = e,
                                u = {
                                    thousand: 3,
                                    million: 6,
                            ...
                            if (a.zeroFormat && e === a.zeroFormat) t = 0;
                                ...
                                for (r in t = 1, "." !== o.delimiters.decimal && (e = e.replace(/\./g, "").replace(o.delimiters.decimal, ".")), u)
                                    if (n = new RegExp("[^a-zA-Z]" + o.abbreviations[r] + "(?:\\)|(\\" + o.currency.symbol + ")?(?:\\))?)?$"), l.match(n)) {
                                        t *= Math.pow(10, u[r]);
                                        break
                                    }
                    ...
                    }, e.options = a, e.formats = n, e.locales = i, e.locale = function(e) {
                        ...
                        format: function(r, t) {
                            var i, o, l, u = this._value,
                                s = r || a.defaultFormat;
                            if (t = t || Math.round, 0 === u && null !== a.zeroFormat) o = a.zeroFormat;
                    ...
                    function() {
                        ...
                        n = "(" + n.replace("B", "B(?!PS)") + ")", e.register("format", "bytes", {
                            ...
                            format: function(n, i, o) {
                                var a, l, u, s = e._.includes(i, "ib") ? t : r,
                                    c = e._.includes(i, " b") || e._.includes(i, " ib") ? " " : "";
                                for (i = i.replace(/\s?i?b/, ""), a = 0; a <= s.suffixes.length; a++)
                                    if (l = Math.pow(s.base, a), u = Math.pow(s.base, a + 1), null === n || 0 === n || n >= l && n < u) {
                        ...
                        unformat: function(r) {
                            ...
                            return i = e._.includes(r, "e-") ? i *= -1 : i, e._.reduce([n, Math.pow(10, i)], o, 1)
                        }
            ...
            }, void 0 === (i = "function" === typeof n ? n.call(r, t, r, e) : n) || (e.exports = i)
        }
    }
]);