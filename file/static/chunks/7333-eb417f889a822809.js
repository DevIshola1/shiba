                    ...
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.componentDidMount = function() {
                        ...
                        if (void 0 === s && (s = ""), t !== r) {
                            ...
                            var u = this.formatNumString(s),
                                ...
                                c = parseFloat(p),
                                f = parseFloat(s);
                            (isNaN(c) && isNaN(f) || c === f) && u === a && (null !== n || l === a) || this.updateValue({
                                formattedValue: l,
                                numAsString: p,
                                input: n,
                                source: "prop",
                        ...
                        return -1 !== a && (t = t.substring(0, a) + "." + t.substring(a + 1, t.length).replace(new RegExp(s(r), "g"), "")), n && (t = "-" + t), t
                        ...
                        return new RegExp("[0-9" + (a ? a.join("") : "") + "]" + (!i || 0 === n || e || o ? "" : "|" + s(i)), t ? "g" : void 0)
                        ...
                        c(t, e), this.caretPositionTimeout = setTimeout((function() {
                            t.value === r && c(t, e)
                        }), 0)
                        ...
                        for (var p = s.substring(e, s.length).indexOf("#"), c = e, h = e + (-1 === p ? 0 : p); c > l && ("#" !== s[c] || !a(t[c]));) c -= 1;
                        return !a(t[h]) || "left" === r && e !== l || e - c < h - e ? a(t[c]) ? c + 1 : c : h
                    }, e.prototype.getCaretPosition = function(t, e, r) {
                        var o, n, a = this.props.format,
                            i = this.state.value,
                        ...
                        for (o = 0, n = 0; n < r; n++) {
                            var p = t[n] || "",
                                c = e[o] || "";
                            if ((p.match(s) || p === c) && ("0" !== p || !c.match(s) || "0" === c || u.length === l.length)) {
                                for (; p !== e[o] && o < e.length;) o++;
                                o++
                            }
                        }
                        return "string" !== typeof a || i || (o = e.length), o = this.correctCaretPosition(e, o)
                        ...
                        if (!r && t) {
                            ...
                            var i = (t = o && 0 === t.indexOf(o) ? t.substring(o.length, t.length) : t).lastIndexOf(n);
                            t = n && -1 !== i && i === t.length - n.length ? t.substring(0, i) : t, a && (t = "-" + t)
                        }
                        return t
                    }, e.prototype.removePatternFormatting = function(t) {
                        for (var e = this.props.format.split("#").filter((function(t) {
                                return "" !== t
                            })), r = 0, o = "", n = 0, a = e.length; n <= a; n++) {
                            var i = e[n] || "",
                        ...
                        return t ? (r ? t = "string" === typeof r ? this.removePatternFormatting(t) : "function" === typeof o ? o(t) : (t.match(this.getNumberRegex(!0)) || []).join("") : (t = this.removePrefixAndSuffix(t), t = this.getFloatString(t)), t) : t
                    }, e.prototype.formatWithPattern = function(t) {
                        for (var e = this.props.format, r = 0, o = e.split(""), n = 0, a = e.length; n < a; n++) "#" === e[n] && (o[n] = t[r] || this.getMaskAtIndex(r), r += 1);
                        return o.join("")
                        ...
                        var e = this.props,
                            ...
                            d = m.afterDecimal,
                            v = m.addNegation;
                        return void 0 !== r && (d = l(d, r, o)), c && (g = function(t, e, r) {
                            var o = function(t) {
                                    switch (t) {
                                        case "lakh":
                                ...
                                n = t.search(/[1-9]/);
                            return n = -1 === n ? t.length : n, t.substring(0, n) + t.substring(n, t.length).replace(o, "$1" + e)
                        }(g, c, s)), n && (g = n + g), a && (d += a), v && (g = "-" + g), t = g + (h && f || "") + d
                        ...
                        return a = "" !== t || o ? "-" !== t || r ? "string" === typeof r ? this.formatWithPattern(a) : "function" === typeof r ? r(a) : this.formatAsNumber(a) : "-" : ""
                        ...
                        var e = this.props,
                            ...
                            f = s.isNumericString,
                            h = !(c = i(c) ? t : c) && 0 !== c;
                        return h && a && (c = ""), h && !a ? "" : ("number" === typeof c && (c = function(t) {
                            var e = "-" === (t += "")[0] ? "-" : "";
                            e && (t = t.substring(1));
                            var r = t.split(/[eE]/g),
                                o = r[0],
                            ...
                            return a < 0 ? o = "0." + p("0", Math.abs(a)) + o : a >= i ? o += p("0", a - i) : o = (o.substring(0, a) || "0") + "." + o.substring(a), e + o
                        }(c), f = !0), "Infinity" === c && f && (c = ""), f && !r && "number" === typeof o && (c = function(t, e, r) {
                            ...
                            }), c[0]) + (o ? "." : "") + l(c[1] || "", Math.min(e, i.length), r)
                        }(c, o, n)), f ? this.formatNumString(c) : this.formatInput(c))
                        ...
                        return "string" === typeof o && "#" !== o[t] || !(o || !(t < n.length || t >= e.length - a.length || i && s && e[t] === u))
                        ...
                        if (r.length > e.length || !r.length || y === x || 0 === d && v === e.length || 0 === y && x === e.length || d === w && v === N) return r;
                        var P = e.substr(y, x - y);
                        if (!![].concat(P).find((function(t, r) {
                        ...
                        void 0 === i && (i = this.removeFormatting(e)), e !== l && (this.setState({
                            value: e,
                            numAsString: i
                        }), u(this.getValueObject(e, i), {
                            event: a,
                            source: n
                        }))
                        ...
                        if (this.selectionBeforeInput = {
                                selectionStart: n,
                                selectionEnd: a
                            }, "ArrowLeft" === o || "Backspace" === o ? e = n - 1 : "ArrowRight" === o ? e = n + 1 : "Delete" === o && (e = n), void 0 !== e && n === a) {
                            var S = e,
                            ...
                            if ("ArrowLeft" === o || "ArrowRight" === o) {
                                ...
                                for (; !g.test(i[S]) && S < x;) S++;
                            (S !== e || e < y || e > x) && (t.preventDefault(), this.setPatchedCaretPosition(r, S, i)), t.isUnitTestRun && this.setPatchedCaretPosition(r, S, i), h(t)
                        } else h(t)
                        ...
                        t.persist(), this.focusedElm = t.target, this.focusTimeout = setTimeout((function() {
                            ...
                            i === o || 0 === o && n === a.length || e.setPatchedCaretPosition(r, i, a), e.props.onFocus(t)
                        }), 0)
                        ...
                        if ("text" === r) return a ? a(p, u) || null : o.createElement("span", Object.assign({}, u, {
                            ref: i
                        }), p);
                        if (n) {
                            var h = n;
                            return o.createElement(h, Object.assign({}, f, {
                                ref: i
                            }))
                        }
                        return o.createElement("input", Object.assign({}, f, {
                            ref: i
                        }))
                    }, e
                }(o.Component);
